...
export default function CertificationPage({location, pageContext}:{location:any,pageContext:CertificationPageInterface}){
    return <Layout location={location}>
        <div className="pmp">
            ...
            <CertificationPageInfo logo={pageContext.logo} logoAltText={pageContext.logoAlt} description1={pageContext.metaDescription} description2={''} slug={pageContext.slug}/>
            <HowItWorks/>
