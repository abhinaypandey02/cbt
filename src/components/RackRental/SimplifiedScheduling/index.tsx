...
export default function SimplifiedScheduling(){
    return <div className="simplified-scheduling">
        <div className="image">
            <StaticImage src={'../../../images/rackRental/simplifiedScheduling.png'} alt={"Simplified Scheduling"}/>
        </div>
        <div className="content">
            ...
            <button className="watch-video"><StaticImage src={'../../../images/rackRental/play.png'} alt={"Play"}/> Watch Video</button>
        </div>
    </div>
}
