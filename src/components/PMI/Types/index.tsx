...
const TYPES=[
    {
        logo:<StaticImage src={'../../../images/pmi/type1.png'} alt={"Professional in Business Analysis – Proxy Exam"}/>,
        ...
        logo:<StaticImage src={'../../../images/pmi/type2.png'} alt={"Project Management Professional (PMP)"}/>,
        title:"Project Management Professional (PMP)",
        desc:"PMP certification is ranked as one of the most prestigious project management certifications globally.",
    },{
        logo:<StaticImage src={'../../../images/pmi/type3.png'} alt={"Agile Certified Practitioner (ACP)"}/>,
        ...
        logo:<StaticImage src={'../../../images/pmi/type4.png'} alt={"Certified Associate in Project Management (CAPM)"}/>,
        ...
        logo:<StaticImage src={'../../../images/pmi/type5.png'} alt={"Risk Management Professional (RMP) – Proxy Exam"}/>,
